...
APP_PATH="src-tauri/gen/apple/build/${APP_ARCH_DIR}/CodexStudy.app"
if [[ ! -d "$APP_PATH" ]]; then
  FALLBACK_APP="$(find src-tauri/gen/apple/build -maxdepth 3 \( -name 'CodexStudy.app' -o -name 'Codex.app' \) | head -n 1 || true)"
