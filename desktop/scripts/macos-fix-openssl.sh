...
app_path="${1:-src-tauri/target/release/bundle/macos/CodexStudy.app}"
...
bin_path="${app_path}/Contents/MacOS/codexstudy"
daemon_path="${app_path}/Contents/MacOS/codexstudy_daemon"
daemonctl_path="${app_path}/Contents/MacOS/codexstudy_daemonctl"
daemon_source="${DAEMON_BINARY_PATH:-src-tauri/target/release/codexstudy_daemon}"
daemonctl_source="${DAEMONCTL_BINARY_PATH:-src-tauri/target/release/codexstudy_daemonctl}"
