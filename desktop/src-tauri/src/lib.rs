...
pub fn run() {
    ...
    let builder = builder
        ...
        .setup(|app| {
            ...
            crate::codex::home::configure_process_codex_home(&data_dir)?;
            if let Err(err) = crate::shared::provider_config_core::ensure_codexstudy_config_defaults()
            {
            ...
            #[cfg(desktop)]
            {
                let app_handle = app.handle().clone();
                tauri::async_runtime::spawn(async move {
                    if let Err(err) = computer_use::ensure_installed_when_enabled().await {
                        eprintln!("[computer-use] startup install skipped: {err}");
                    }
                });
            }
            #[cfg(target_os = "macos")]
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            codex::home_migration::codex_home_migration_status,
            codex::home_migration::codex_home_migration_import,
            codex::home_migration::codex_home_migration_skip,
            ...
            codex_new::codex_new_sync_viewing_context,
            codex_new::codex_new_get_state,
            codex_new::codex_new_enable_security,
            codex_new::codex_new_sync_thread_titles,
            codex_new::codex_new_disable_security,
            codex_new::codex_new_focus_session,
            codex_new::codex_new_refresh_changes,
            codex_new::codex_new_run_review,
            codex_new::codex_new_merge_changes,
            codex_new::codex_new_rollback_task,
            codex_new::codex_new_write_summary,
            codex_new::codex_new_run_test,
            codex_new::codex_new_read_file_preview,
            codex_new::codex_new_list_traceback,
            ...
            computer_use::computer_use_get_status,
            computer_use::computer_use_set_enabled,
            computer_use::computer_use_repair_install,
            computer_use::computer_use_run_doctor,
            computer_use::computer_use_prepare_workspace_dir,
            codex::get_model_provider_settings,
            codex::save_model_provider_settings,
            codex::diagnose_model_provider_connection,
            codex::get_model_provider_history,
            codex::sync_current_model_provider_history_models,
            codex::delete_model_provider_history_entry,
