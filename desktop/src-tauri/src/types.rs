...
#[serde(rename_all = "camelCase")]
pub(crate) enum ModelProviderCompatKind {
    DeepSeek,
    Qwen,
    Doubao,
    Zhipu,
...
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub(crate) struct ModelProviderCompatSettings {
    pub(crate) kind: ModelProviderCompatKind,
    #[serde(rename = "upstreamBaseUrl")]
    pub(crate) upstream_base_url: String,
    #[serde(default, rename = "supportsImageInput")]
    pub(crate) supports_image_input: Option<bool>,
}

#[derive(Debug, Serialize, Deserialize, Clone)]
#[serde(rename_all = "camelCase")]
pub(crate) struct VisionFallbackSettings {
    #[serde(default)]
    pub(crate) enabled: bool,
    #[serde(default = "default_vision_fallback_preset")]
    pub(crate) preset: VisionFallbackPreset,
    #[serde(default = "default_vision_fallback_base_url", rename = "baseUrl")]
...
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Eq)]
#[serde(rename_all = "lowercase")]
pub(crate) enum VisionFallbackPreset {
    Doubao,
    Qwen,
    Zhipu,
    Moonshot,
...
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
pub(crate) struct ModelProviderHistoryEntry {
    pub(crate) id: String,
...
pub(crate) struct AppSettings {
    ...
    #[serde(default, rename = "modelProviderCompat")]
    pub(crate) model_provider_compat: Option<ModelProviderCompatSettings>,
    #[serde(default, rename = "modelProviderHistory")]
    pub(crate) model_provider_history: Vec<ModelProviderHistoryEntry>,
    #[serde(default, rename = "visionFallback")]
    pub(crate) vision_fallback: Option<VisionFallbackSettings>,
...
fn default_vision_fallback_preset() -> VisionFallbackPreset {
    VisionFallbackPreset::Doubao
}
...
fn default_vision_fallback_model() -> String {
    "doubao-1.5-vision-pro-32k-250115".to_string()
}
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            model_provider_compat: None,
            model_provider_history: Vec::new(),
            vision_fallback: Some(VisionFallbackSettings {
                enabled: false,
                preset: default_vision_fallback_preset(),
                base_url: default_vision_fallback_base_url(),
...
mod tests {
    ...
    fn app_settings_defaults_from_empty_json() {
        ...
        assert!(settings.model_provider_history.is_empty());
