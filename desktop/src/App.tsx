...
import "./styles/codex-home-migration-modal.css";
import "./styles/settings.css";
import "./styles/compact-base.css";
import "./styles/compact-phone.css";
import "./styles/compact-tablet.css";
import { useWindowLabel } from "@/features/layout/hooks/useWindowLabel";
import { CodexNewWindowApp } from "@/features/codex-new/components/CodexNewWindowApp";
...
export default function App() {
  ...
  if (windowLabel === "codex-new-process") {
    return <CodexNewWindowApp kind="process" />;
  }

  if (windowLabel === "codex-new-terminal") {
    return <CodexNewWindowApp kind="terminal" />;
  }
