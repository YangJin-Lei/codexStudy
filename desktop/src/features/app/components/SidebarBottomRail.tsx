      ...
      {showAccountUsage && (
        <div className="sidebar-usage-panel">
          <div className="sidebar-usage-header">
            <div className="sidebar-usage-kicker">{t("sidebar.usage", "Usage")}</div>
            {creditsLabel && <div className="sidebar-usage-credits">{creditsLabel}</div>}
          </div>
          <div className="sidebar-usage-list">
            <UsageRow
              label={t("sidebar.usage.session", "Session")}
              percent={sessionPercent}
              resetLabel={sessionResetLabel}
            />
            {showWeekly && (
              <UsageRow
                label={t("sidebar.usage.weekly", "Weekly")}
          ...
          <div className="sidebar-account-menu" ref={accountMenuRef}>
            ...
            {accountMenuOpen && (
              <PopoverSurface className="sidebar-account-popover" role="dialog">
                <div className="sidebar-account-title">{t("sidebar.account", "Account")}</div>
                ...
                <div className="sidebar-account-actions-row">
                  ...
                  {accountSwitching && (
                    <button
                      ...
                      aria-label={t("sidebar.cancelAccountSwitch", "Cancel account switch")}
                      title={t("sidebar.cancel", "Cancel")}
                    >
        ...
        <div className="sidebar-utility-actions">
          ...
          {showDebugButton && (
            <button
              ...
              type="button"
              onClick={onOpenDebug}
              aria-label={t("sidebar.openDebugLog", "Open debug log")}
            >
