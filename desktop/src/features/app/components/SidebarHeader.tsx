      ...
      <div className="sidebar-header-title">
        <div className="sidebar-title-group">
          <button
            ...
            aria-label={t("sidebar.addWorkspaces", "Add workspaces")}
            data-tooltip={t("sidebar.addWorkspaces", "Add workspaces")}
          ...
          <button
            ...
            data-tauri-drag-region="false"
            aria-label={t("sidebar.openHome", "Open home")}
          >
      ...
      <div className="sidebar-header-actions">
        <div className="sidebar-sort-menu" ref={sortMenuRef}>
          <MenuTrigger
            ...
            data-tauri-drag-region="false"
            aria-label={t("sidebar.organizeSort", "Organize and sort threads")}
            title={t("sidebar.organizeSort", "Organize and sort threads")}
            data-tooltip={t("sidebar.organizeSort", "Organize and sort threads")}
          ...
          {sortMenuOpen && (
            ...
            >
              ...
              >
                {t("sidebar.organize.byProject", "By project")}
              </PopoverMenuItem>
              <PopoverMenuItem
                className="sidebar-sort-option"
                role="menuitemradio"
              ...
              >
                {t("sidebar.organize.byProjectActivity", "By project activity")}
              </PopoverMenuItem>
              <PopoverMenuItem
                className="sidebar-sort-option"
                role="menuitemradio"
              ...
              >
                {t("sidebar.organize.threadList", "Thread list")}
              </PopoverMenuItem>
              <div className="sidebar-sort-divider" aria-hidden />
              <div className="sidebar-sort-section-label">
                {t("sidebar.sortBy", "Sort by")}
              </div>
              <PopoverMenuItem
                className="sidebar-sort-option"
                role="menuitemradio"
