...
type UseMainAppLayoutSurfacesArgs = {
  ...
  computerUseControl: {
    computerUseWorkspaceId: SidebarProps["computerUseWorkspaceId"];
    computerUseEnabled: SidebarProps["computerUseEnabled"];
    computerUseReady: SidebarProps["computerUseReady"];
    computerUseStatusLoading: SidebarProps["computerUseStatusLoading"];
    computerUseStarting: SidebarProps["computerUseStarting"];
    computerUseActionError: SidebarProps["computerUseActionError"];
    onStartComputerUseSession: NonNullable<SidebarProps["onStartComputerUseSession"]>;
    onOpenComputerUseSettings: NonNullable<SidebarProps["onOpenComputerUseSettings"]>;
  };
...
function buildPrimarySurface({
  ...
  return {
    sidebarProps: {
      ...
      computerUseWorkspaceId: computerUseControl.computerUseWorkspaceId,
      computerUseEnabled: computerUseControl.computerUseEnabled,
      computerUseReady: computerUseControl.computerUseReady,
      computerUseStatusLoading: computerUseControl.computerUseStatusLoading,
      computerUseStarting: computerUseControl.computerUseStarting,
      computerUseActionError: computerUseControl.computerUseActionError,
      onStartComputerUseSession: computerUseControl.onStartComputerUseSession,
      onOpenComputerUseSettings: computerUseControl.onOpenComputerUseSettings,
    },
    messagesProps: {
      items: activeItems,
    ...
    composerProps: composerWorkspaceState.showComposer
      ? {
          ...
          attachedFiles: composerWorkspaceState.activeFiles,
          visionFallbackReady: appSettings.visionFallbackReady,
          onPickAttachments: composerWorkspaceState.pickAttachments,
