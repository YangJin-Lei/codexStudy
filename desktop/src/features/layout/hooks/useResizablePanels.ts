...
const STORAGE_KEY_SIDEBAR = "codexstudy.sidebarWidth";
const STORAGE_KEY_RIGHT_PANEL = "codexstudy.rightPanelWidth";
const STORAGE_KEY_CHAT_DIFF_SPLIT_POSITION_PERCENT =
  "codexstudy.chatDiffSplitPositionPercent";
const STORAGE_KEY_PLAN_PANEL = "codexstudy.planPanelHeight";
const STORAGE_KEY_TERMINAL_PANEL = "codexstudy.terminalPanelHeight";
const STORAGE_KEY_DEBUG_PANEL = "codexstudy.debugPanelHeight";
