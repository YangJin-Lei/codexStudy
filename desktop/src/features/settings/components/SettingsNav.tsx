  ...
  return (
    <aside className="settings-sidebar">
      <PanelNavList className="settings-nav-list">
        ...
        >
          {t("settings.nav.display", "Display & Sound")}
        </PanelNavItem>
        <PanelNavItem
          className="settings-nav"
        ...
        >
          {t("settings.nav.composer", "Composer")}
        </PanelNavItem>
        <PanelNavItem
          className="settings-nav"
        ...
        >
          {t("settings.nav.dictation", "Dictation")}
        </PanelNavItem>
        <PanelNavItem
          className="settings-nav"
        ...
        >
          {t("settings.nav.shortcuts", "Shortcuts")}
        </PanelNavItem>
        <PanelNavItem
          className="settings-nav"
        ...
        >
          {t("settings.nav.openApps", "Open in")}
        </PanelNavItem>
        <PanelNavItem
          className="settings-nav"
        ...
        >
          {t("settings.nav.codex", "Codex")}
        </PanelNavItem>
        <PanelNavItem
          className="settings-nav"
          icon={<Monitor aria-hidden />}
          active={activeSection === "computer-use"}
          showDisclosure={showDisclosure}
          onClick={() => onSelectSection("computer-use")}
        >
          {t("settings.nav.computerUse", "Computer Use")}
        </PanelNavItem>
        <PanelNavItem
          className="settings-nav"
        ...
        >
          {t("settings.nav.features", "Features")}
        </PanelNavItem>
        <PanelNavItem
          className="settings-nav"
