import { SettingsComputerUseSection } from "./SettingsComputerUseSection";
...
export function SettingsSectionContainers({
  ...
  if (activeSection === "computer-use") {
    return <SettingsComputerUseSection {...orchestration.computerUseSectionProps} />;
  }
  return null;
}
