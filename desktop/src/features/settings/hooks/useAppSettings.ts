...
import type { VisionFallbackSettings } from "@/types";
...
const DEFAULT_VISION_FALLBACK: VisionFallbackSettings = {
  enabled: false,
  preset: "doubao",
...
function buildDefaultSettings(): AppSettings {
  ...
  return {
    ...
    visionFallback: DEFAULT_VISION_FALLBACK,
    workspaceGroups: [],
...
function normalizeAppSettings(settings: AppSettings): AppSettings {
  ...
  const visionFallback = settings.visionFallback
    ? {
        ...DEFAULT_VISION_FALLBACK,
        ...settings.visionFallback,
        baseUrl:
          settings.visionFallback.baseUrl?.trim() || DEFAULT_VISION_FALLBACK.baseUrl,
        model: settings.visionFallback.model?.trim() || DEFAULT_VISION_FALLBACK.model,
        apiKey: settings.visionFallback.apiKey?.trim()
          ? settings.visionFallback.apiKey.trim()
          : null,
      }
    : DEFAULT_VISION_FALLBACK;
  return {
