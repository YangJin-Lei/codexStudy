...
describe("useThreads UX integration", () => {
  ...
  it("starts a fresh thread after provider session refresh invalidates the active thread", async () => {
    ...
    } as Awaited<ReturnType<typeof listThreads>>);
    ...
    act(() => {
      window.dispatchEvent(
        new CustomEvent(MODEL_PROVIDER_SESSION_REFRESHED_EVENT, {
          detail: { affectedWorkspaceCount: 1 },
        }),
      );
    });
