import {
  CODEXSTUDY_GITHUB_RELEASES_API,
  CODEXSTUDY_GITHUB_RELEASES_WEB,
} from "@/codexStudyRepo";

export const STORAGE_KEY_PENDING_POST_UPDATE_VERSION =
  "codexstudy.pendingPostUpdateVersion";
const GITHUB_RELEASES_API_BASE = CODEXSTUDY_GITHUB_RELEASES_API;
const GITHUB_RELEASES_WEB_BASE = CODEXSTUDY_GITHUB_RELEASES_WEB;
