...
export type CodexNewFocusThreadPayload = {
  workspaceId: string;
  threadId: string;
  processTab?: "timeline" | "changes" | "review" | "summary";
};
...
export type VisionFallbackPreset =
  | "doubao"
  | "qwen"
  | "zhipu"
  | "moonshot"
...
export type VisionFallbackSettings = {
  enabled: boolean;
  preset: VisionFallbackPreset;
  baseUrl: string;
  model: string;
  apiKey?: string | null;
};
...
export type AppSettings = {
  ...
  codeFontSize: number;
  uiLanguage?: UiLanguagePreference | null;
  ...
  modelProviderHistory?: ModelProviderHistoryEntry[];
...
export type ModelProviderAuthMode = "chatgpt" | "apiKey" | "none" | "aws";

export type ModelProviderConnectionMode =
  | "managedLogin"
  | "direct"
  | "compatibilityBridge";

export type ModelProviderConnectionStatus = "ok" | "warning" | "error";
...
export type ModelProviderHistoryEntry = {
  id: string;
  preset: ModelProviderPreset;
  providerName: string;
  baseUrl: string | null;
...
export type SaveModelProviderSettingsInput = {
  ...
  baseUrl?: string | null;
  authMode?: ModelProviderAuthMode | null;
  apiKey?: string | null;
  awsProfile?: string | null;
  awsRegion?: string | null;
};

export type SaveModelProviderSettingsResult = {
  settings: ModelProviderSettings;
  history: ModelProviderHistoryEntry[];
  respawned: boolean;
  affectedWorkspaceCount: number;
};

export type DeleteModelProviderHistoryEntryResult = {
  settings: ModelProviderSettings;
  history: ModelProviderHistoryEntry[];
...
export type ModelProviderConnectionDiagnostic = {
  preset: ModelProviderPreset;
  providerName: string;
